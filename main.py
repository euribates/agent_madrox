...
import dba
from models import Tarea, Jornada
from clitools import ERROR, OK, SKIP
...
# def migrar_tarea(db_source, db_target, id_tarea):
    ...
    # if new_values != old_values:  # Update
        ...
        # target_item.update(db_target, id_tarea, diff_values)
        # logging.info(f"- Update Jornada {OK}")
        # return True, 'Updated'
...
def main():
    ...
    print(f"Actualizando jornadas desde hace {num_dias} dias")
    ...
    print(f"Actualizando tareas desde hace {num_dias} días")
